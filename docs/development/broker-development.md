...
| ONVIF             | `ghcr.io/project-akri/examples/onvif-video-broker:v0.14.0`      | .NET camera frame server                                       |
| OPC UA            | `ghcr.io/project-akri/examples/opcua-monitoring-broker:v0.14.0` | .Net App subscribes to specific NodeID and serves latest value |
| udev              | `ghcr.io/project-akri/examples/udev-video-broker:v0.14.0`       | Rust camera frame server                                       |
