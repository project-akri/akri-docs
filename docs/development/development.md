...
## Running locally
Before running Akri agent or controller locally, please ensure Akri configuration and instance CRDs are created in cluster, otherwise use the below command to create.
```sh
